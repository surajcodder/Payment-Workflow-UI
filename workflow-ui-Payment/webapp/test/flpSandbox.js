		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#PaymentWorkflowworkflowuiPayment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"PaymentWorkflowworkflowuiPayment-display": {
								"semanticObject": "PaymentWorkflowworkflowuiPayment",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=PaymentWorkflow.workflowuiPayment",
									"url": sap.ui.require.toUrl("PaymentWorkflow/workflowuiPayment")
								}
							}
						}
					}
